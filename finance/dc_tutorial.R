...
SBUX_prices = get.hist.quote(instrument="sbux", start="1998-01-01", end="2009-12-31", quote="AdjClose", provider="yahoo",
...
all_prices = cbind(VBLTX_prices, FMAGX_prices, SBUX_prices)
# Rename columns
